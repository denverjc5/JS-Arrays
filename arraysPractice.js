...
// (all the even values from numbersArray) and the second item in the Array being
//the odds array (all the odd values from numbersArray).
...
/*
  ...
  Specrunner will try to call your functions without passing in valid aurguments. When this happens,
  you will need to respond by returning an empty array.
*/
...
function longer(arr1, arr2) {
  ...
  return arr1.length > arr2 ? arr1 : arr2;
...
for (var i = 0; i < devMountainEmployees.length; i++) {
  ...
  var element = devMountainEmployees[i];
...
var user1 = {
    name: 'Tyler McGinnis',
    email: 'tuser133@gmail.com',
    password: 'iLoveJavaScript',
    username: 'infiniateLoop1'
};
...
Once you find the particular index he's located in, delete him from the array.*/
  ...
  for (var i = 0; i < users.length; i ++) {
    ...
    if (element.email === 'tuser133@gmail.com')
    {
      users.splice(i, 1);
